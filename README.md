...
> [!IMPORTANT]
> In order for the `Configurable` menu to be visible, make sure to specify `configSchema` when creating `StateGraph`. You can read more about how to add config schema to your graph [here](https://langchain-ai.github.io/langgraph/how-tos/configuration/#configure-the-graph).
